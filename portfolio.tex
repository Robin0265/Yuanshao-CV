...
\begin{enumerate}
    ...
    \item {Mechanical Design of the Components of Robot Swimmer, with Computational Fluid Dynamics (CFD) analysis to validate the design, as shown in Figure \ref*{Control-RobotSwimmer}. }
    ...
    \begin{figure}[H]
        \centering
        \includegraphics*[width = 0.7\textwidth]{portfolio/FBD_RobotSwimmer.png}
